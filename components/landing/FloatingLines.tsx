...
type FloatingLinesProps = {
  ...
  mixBlendMode?: "normal" | "screen" | "overlay" | "lighten";
};
...
export default function FloatingLines({
  ...
  return (
    <div
      ref={containerRef}
      style={{ mixBlendMode, width: "100%", height: "100%", position: "relative", overflow: "hidden" }}
    />
  );
}

...
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/linkify/components/ui/card";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/linkify/components/ui/tabs";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@/linkify/components/ui/tooltip";
import { cn, PLANS } from "@/linkify/utils";
            ...
            <TabsContent value="monthly" className="grid grid-cols-1 lg:grid-cols-3 gap-5 w-full md:gap-8 flex-wrap max-w-5xl mx-auto pt-6">
                {PLANS.map((plan) => (
                    <Card
                        key={plan.name}
                        className={cn(
                            "flex flex-col w-full border-border/20 rounded-xl",
                                    ...
                                    <TooltipProvider>
                                        <Tooltip delayDuration={0}>
                                            <TooltipTrigger asChild>
                                                <p className={cn(feature.tooltip && "border-b !border-dashed border-border/20 cursor-pointer")}>
                                                    {feature.text}
                                                </p>
                                            </TooltipTrigger>
                                            {feature.tooltip && (
